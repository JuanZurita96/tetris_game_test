...
import { getTickTime } from "../utils/functions";
import { TetrisCallbackName, GameState } from "../interface/tetrisTypes";
...
type TetrisActionsContext = {
  ...
  registerCallback: (name: TetrisCallbackName) => void;
};
